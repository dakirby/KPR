...
/**************degradation rates*****************/
	 	 rate=0.28196397075942914*s[0];
	 	 increment=rate;
	 	 ds[0]-=increment;
	 	 rate=0.00473986488050715*s[1];
	 	 increment=rate;
	 	 ds[1]-=increment;
	 	 rate=0.7983234746016786*s[2];
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 rate=0.5511359206533945*s[3];
	 	 increment=rate;
	 	 ds[3]-=increment;
	 	 rate=0.925136695946104*s[4];
	 	 increment=rate;
	 	 ds[4]-=increment;
	 	 rate=0.1520493963657864*s[5];
	 	 increment=rate;
	 	 ds[5]-=increment;
	 	 rate=0.45698740673742777*s[6];
	 	 increment=rate;
	 	 ds[6]-=increment;
	 	 rate=0.9954505254257431*s[7];
	 	 increment=rate;
	 	 ds[7]-=increment;
	 	 rate=0.09165797009325227*s[8];
	 	 increment=rate;
	 	 ds[8]-=increment;
...
/**************Transcription rates*****************/
	 ...
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.510985*HillA(history[2][memory][ncell],0.406893,4.082712),0.000000);
	 	 increment=rate;
	 	 ds[3]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.652595,0.000000);
	 	 increment=rate;
	 	 ds[4]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.193917,0.000000);
	 	 increment=rate;
	 	 ds[5]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.328141,0.000000);
	 	 increment=rate;
	 	 ds[7]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.488282,0.000000);
	 	 increment=rate;
	 	 ds[8]+=increment;
	}
...
total=1+POW(s[2]/0.309448,0.120082);
	 	/*Phosphorylation*/
	 	 rate=0.109607*s[4]*(POW(s[2]/0.309448,0.120082)/total);
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 ds[6]+=increment;
	 	 /*Dehosphorylation*/
