...
static int tracklig[] = {};
static int trackdiff[] = {1, 7};
static double diff_constant[] = {0.26485056176911315, 0.8626371242491369};
...
/**************degradation rates*****************/
	 	 rate=0.9912198585282835*s[0];
	 	 increment=rate;
	 	 ds[0]-=increment;
	 	 rate=0.00473986488050715*s[1];
	 	 increment=rate;
	 	 ds[1]-=increment;
	 	 rate=0.5849358234770273*s[2];
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 rate=0.874374882892466*s[3];
	 	 increment=rate;
	 	 ds[3]-=increment;
	 	 rate=0.5126676536673141*s[4];
	 	 increment=rate;
	 	 ds[4]-=increment;
	 	 rate=0.2750226169922493*s[5];
	 	 increment=rate;
	 	 ds[5]-=increment;
	 	 rate=0.876704942343578*s[6];
	 	 increment=rate;
	 	 ds[6]-=increment;
	 	 rate=0.889940507196237*s[7];
	 	 increment=rate;
	 	 ds[7]-=increment;
	 	 rate=0.22995814727698605*s[8];
	 	 increment=rate;
	 	 ds[8]-=increment;
	 	 rate=0.5849358234770273*s[9];
	 	 increment=rate;
	 	 ds[9]-=increment;
...
/**************Transcription rates*****************/
	 ...
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.981111,0.000000);
	 	 increment=rate;
	 	 ds[1]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.942954*HillA(history[2][memory][ncell],0.039383,3.094152),0.000000);
	 	 increment=rate;
	 	 ds[3]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.057050,0.000000);
	 	 increment=rate;
	 	 ds[4]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.222867,0.000000);
	 	 increment=rate;
	 	 ds[5]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.933361,0.000000);
	 	 increment=rate;
	 	 ds[7]+=increment;
	}

/**************Protein protein interactions*****************/
	 	 rate=0.081885 * s[1] * s[0];
	 	 increment=rate;
	 	 ds[1]-=increment;
	 	 ds[0]-=increment;
	 	 ds[2]+=increment;
...
total=1+POW(s[2]/0.888409,1.006400);
	 	/*Phosphorylation*/
	 	 rate=0.735008*s[2]*(POW(s[2]/0.888409,1.006400)/total);
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 ds[9]+=increment;
	 	 /*Dehosphorylation*/
...
total=1+POW(s[2]/0.487809,3.642235)+POW(s[4]/0.160503,2.292534);
	 	/*Phosphorylation*/
	 	 rate=0.901048*s[4]*(POW(s[2]/0.487809,3.642235)/total);
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 ds[6]+=increment;
	 	 /*Dehosphorylation*/
	 	...
	 	/*Phosphorylation*/
	 	 rate=0.510897*s[4]*(POW(s[4]/0.160503,2.292534)/total);
	 	 increment=rate;
	 	 ds[4]-=increment;
	 	 ds[8]+=increment;
	 	 /*Dehosphorylation*/
