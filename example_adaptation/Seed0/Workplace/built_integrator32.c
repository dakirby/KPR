...
/**************degradation rates*****************/
	 	 ...
	 	 increment=rate;
	 	 ds[3]-=increment;
	 	 rate=0.39838009247008066*s[4];
	 	 increment=rate;
	 	 ds[4]-=increment;
	 	 rate=0.1520493963657864*s[5];
	 	 increment=rate;
	 	 ds[5]-=increment;
	 	 rate=0.8160072473174819*s[6];
	 	 increment=rate;
	 	 ds[6]-=increment;
	 	 rate=0.20924973840919314*s[7];
	 	 increment=rate;
	 	 ds[7]-=increment;
...
/**************Transcription rates*****************/
	 ...
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.833513,0.000000);
	 	 increment=rate;
	 	 ds[1]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.986857*HillA(history[2][memory][ncell],0.557411,3.263465),0.000000);
	 	 increment=rate;
	 	 ds[3]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.819068*HillA(history[2][memory][ncell],0.563289,0.096866),0.000000);
	 	 increment=rate;
	 	 ds[4]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.149392,0.000000);
	 	 increment=rate;
	 	 ds[5]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.419531,0.000000);
	 	 increment=rate;
	 	 ds[6]+=increment;
	}
