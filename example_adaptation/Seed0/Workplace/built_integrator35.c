...
static double diff_constant[] = {0.26485056176911315, 0.933531699201736};
...
/**************Transcription rates*****************/
	 ...
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.942954*HillA(history[2][memory][ncell],0.776726,4.437961),0.000000);
	 	 increment=rate;
	 	 ds[3]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.432183,0.000000)*HillR(history[1][memory][ncell],0.819147,3.516941);
	 	 increment=rate;
	 	 ds[4]+=increment;
	}
	 memory=step-0;
...
total=1+POW(s[2]/0.094104,4.735474)+POW(s[4]/0.633553,2.037860);
	 	/*Phosphorylation*/
	 	 rate=0.091425*s[4]*(POW(s[2]/0.094104,4.735474)/total);
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 ds[6]+=increment;
	 	 /*Dehosphorylation*/
	 	...
	 	/*Phosphorylation*/
	 	 rate=0.062958*s[4]*(POW(s[4]/0.633553,2.037860)/total);
	 	 increment=rate;
	 	 ds[4]-=increment;
	 	 ds[8]+=increment;
	 	 /*Dehosphorylation*/
