...
/**************degradation rates*****************/
	 	 ...
	 	 increment=rate;
	 	 ds[1]-=increment;
	 	 rate=0.7107172672495798*s[2];
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 rate=0.925136695946104*s[3];
	 	 increment=rate;
	 	 ds[3]-=increment;
	 	 rate=0.1520493963657864*s[4];
	 	 increment=rate;
	 	 ds[4]-=increment;
	 	 rate=0.45698740673742777*s[5];
	 	 increment=rate;
	 	 ds[5]-=increment;
	 	 rate=0.9954505254257431*s[6];
	 	 increment=rate;
	 	 ds[6]-=increment;
	 	 rate=0.09165797009325227*s[7];
	 	 increment=rate;
	 	 ds[7]-=increment;
...
total=1+POW(s[2]/0.309448,0.120082);
	 	/*Phosphorylation*/
	 	 rate=0.109607*s[3]*(POW(s[2]/0.309448,0.120082)/total);
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 ds[5]+=increment;
	 	 /*Dehosphorylation*/
