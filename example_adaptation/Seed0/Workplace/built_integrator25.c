...
/**************degradation rates*****************/
	 	 ...
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 rate=0.08095913305670244*s[3];
	 	 increment=rate;
	 	 ds[3]-=increment;
	 	 rate=0.1520493963657864*s[4];
	 	 increment=rate;
	 	 ds[4]-=increment;
	 	 rate=0.13417813838096282*s[5];
	 	 increment=rate;
	 	 ds[5]-=increment;
	 	 rate=0.09165797009325227*s[6];
	 	 increment=rate;
	 	 ds[6]-=increment;
...
/**************Transcription rates*****************/
	 ...
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.510985*HillA(history[2][memory][ncell],0.887169,2.970994),0.000000);
	 	 increment=rate;
	 	 ds[3]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.392077,0.000000);
	 	 increment=rate;
	 	 ds[4]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.286539,0.000000);
	 	 increment=rate;
	 	 ds[5]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.740187,0.000000);
	 	 increment=rate;
	 	 ds[6]+=increment;
	}
