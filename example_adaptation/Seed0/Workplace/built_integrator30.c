...
/**************degradation rates*****************/
	 	 ...
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 rate=0.29841082447014877*s[3];
	 	 increment=rate;
	 	 ds[3]-=increment;
	 	 rate=0.40075070235422494*s[4];
	 	 increment=rate;
	 	 ds[4]-=increment;
	 	 rate=0.2750226169922493*s[5];
	 	 increment=rate;
	 	 ds[5]-=increment;
	 	 rate=0.8870460540219899*s[6];
	 	 increment=rate;
	 	 ds[6]-=increment;
...
/**************Transcription rates*****************/
	 ...
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.942954*HillA(history[2][memory][ncell],0.619176,3.714058),0.000000);
	 	 increment=rate;
	 	 ds[3]+=increment;
	}
	 memory=step-0;
	 ...
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.251553,0.000000);
	 	 increment=rate;
	 	 ds[5]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.522113,0.000000);
	 	 increment=rate;
	 	 ds[7]+=increment;
	}

/**************Protein protein interactions*****************/
	 	 rate=0.594985 * s[1] * s[0];
	 	 increment=rate;
	 	 ds[1]-=increment;
	 	 ds[0]-=increment;
	 	 ds[2]+=increment;
...
total=1+POW(s[2]/0.715582,3.187296)+POW(s[4]/0.376534,1.582771);
	 	/*Phosphorylation*/
	 	 rate=0.405445*s[4]*(POW(s[2]/0.715582,3.187296)/total);
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 ds[6]+=increment;
	 	 /*Dehosphorylation*/
	 	...
	 	/*Phosphorylation*/
	 	 rate=0.015404*s[4]*(POW(s[4]/0.376534,1.582771)/total);
	 	 increment=rate;
	 	 ds[4]-=increment;
	 	 ds[8]+=increment;
	 	 /*Dehosphorylation*/
