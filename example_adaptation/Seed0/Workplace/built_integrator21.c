...
/**************Transcription rates*****************/
	 ...
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.322717*HillA(history[2][memory][ncell],0.557411,3.263465),0.000000);
	 	 increment=rate;
	 	 ds[3]+=increment;
	}
	 memory=step-0;
...
total=1+POW(s[2]/0.284797,4.810490);
	 	/*Phosphorylation*/
	 	 rate=0.625086*s[4]*(POW(s[2]/0.284797,4.810490)/total);
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 ds[6]+=increment;
	 	 /*Dehosphorylation*/
