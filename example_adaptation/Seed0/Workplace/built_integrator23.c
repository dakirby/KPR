...
static double diff_constant[] = {0.26485056176911315};
...
/**************degradation rates*****************/
	 	 rate=0.9076445519127886*s[0];
	 	 increment=rate;
	 	 ds[0]-=increment;
	 	 rate=0.00473986488050715*s[1];
	 	 increment=rate;
	 	 ds[1]-=increment;
	 	 rate=0.8940166253896831*s[2];
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 rate=0.7751919267095642*s[3];
	 	 increment=rate;
	 	 ds[3]-=increment;
	 	 rate=0.8932742976959775*s[4];
	 	 increment=rate;
	 	 ds[4]-=increment;
	 	 rate=0.4170099242209656*s[5];
	 	 increment=rate;
	 	 ds[5]-=increment;
	 	 rate=0.5438458696766254*s[6];
	 	 increment=rate;
	 	 ds[6]-=increment;
	 	 rate=0.5381873386358783*s[7];
	 	 increment=rate;
	 	 ds[7]-=increment;
	 	 rate=0.3363380107927356*s[8];
	 	 increment=rate;
	 	 ds[8]-=increment;
...
/**************Transcription rates*****************/
	 ...
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.971490,0.000000);
	 	 increment=rate;
	 	 ds[1]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.530024*HillA(history[2][memory][ncell],0.557411,3.263465),0.000000);
	 	 increment=rate;
	 	 ds[3]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.819068,0.000000);
	 	 increment=rate;
	 	 ds[4]+=increment;
	}
	 memory=step-0;
...
total=1+POW(s[2]/0.953737,2.550033);
	 	/*Phosphorylation*/
	 	 rate=0.753466*s[4]*(POW(s[2]/0.953737,2.550033)/total);
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 ds[6]+=increment;
	 	 /*Dehosphorylation*/
...
total=1+POW(s[2]/0.740713,1.622012);
	 	/*Phosphorylation*/
	 	 rate=0.794776*s[6]*(POW(s[2]/0.740713,1.622012)/total);
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 ds[8]+=increment;
	 	 /*Dehosphorylation*/
