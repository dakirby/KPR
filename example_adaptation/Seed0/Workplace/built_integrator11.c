...
static double diff_constant[] = {0.26485056176911315, 0.26370203171705076};
...
total=1+POW(s[2]/0.487809,3.642235)+POW(s[4]/0.633553,2.037860);
	 	/*Phosphorylation*/
