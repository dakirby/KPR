...
static double diff_constant[] = {0.7883923663001193, 0.037008499476751444};
...
/**************degradation rates*****************/
	 	 rate=0.3419287983175623*s[0];
	 	 increment=rate;
	 	 ds[0]-=increment;
	 	 rate=0.32081307184243135*s[1];
	 	 increment=rate;
	 	 ds[1]-=increment;
	 	 rate=0.002503396417111947*s[2];
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 rate=0.09677752445001886*s[3];
	 	 increment=rate;
	 	 ds[3]-=increment;
