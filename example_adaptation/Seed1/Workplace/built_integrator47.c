...
static int trackout[] = {3};
static int tracklig[] = {};
static int trackdiff[] = {1, 2, 3};
static double diff_constant[] = {0.55334432051998, 0.037008499476751444, 0.3774404885303386};
...
/**************degradation rates*****************/
	 	 rate=0.9360768394695549*s[0];
	 	 increment=rate;
	 	 ds[0]-=increment;
	 	 rate=0.8419602527439488*s[1];
	 	 increment=rate;
	 	 ds[1]-=increment;
	 	 rate=0.002503396417111947*s[2];
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 rate=0.4666357896170029*s[3];
	 	 increment=rate;
	 	 ds[3]-=increment;
	 	 rate=0.5869224198722387*s[4];
	 	 increment=rate;
	 	 ds[4]-=increment;
...
/**************Transcription rates*****************/
	 ...
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.777662,0.000000);
	 	 increment=rate;
	 	 ds[1]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.056052,0.000000);
	 	 increment=rate;
	 	 ds[3]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.253767,0.000000);
	 	 increment=rate;
	 	 ds[4]+=increment;
	}
...
total=1+POW(s[1]/0.145086,2.897314);
	 	/*Phosphorylation*/
	 	 rate=0.805651*s[0]*(POW(s[1]/0.145086,2.897314)/total);
	 	 increment=rate;
	 	 ds[1]-=increment;
	 	 ds[2]+=increment;
	 	 /*Dehosphorylation*/
