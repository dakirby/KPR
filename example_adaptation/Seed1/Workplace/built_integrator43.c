...
static double diff_constant[] = {0.5429806431182237, 0.037008499476751444};
...
/**************degradation rates*****************/
	 	 rate=0.8552116997898489*s[0];
	 	 increment=rate;
	 	 ds[0]-=increment;
	 	 rate=0.4088953248139853*s[1];
	 	 increment=rate;
	 	 ds[1]-=increment;
	 	 rate=0.002503396417111947*s[2];
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 rate=0.8664551782397473*s[3];
	 	 increment=rate;
	 	 ds[3]-=increment;
...
/**************Transcription rates*****************/
	 ...
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.631275*HillA(history[1][memory][ncell],0.480840,2.569821),0.000000);
	 	 increment=rate;
	 	 ds[3]+=increment;
	}
