...
static int tracklig[] = {};
static int trackdiff[] = {1, 2};
static double diff_constant[] = {0.8605435486074278, 0.037008499476751444};
...
/**************degradation rates*****************/
	 	 rate=0.8553144018803431*s[0];
	 	 increment=rate;
	 	 ds[0]-=increment;
	 	 rate=0.14971968572858985*s[1];
	 	 increment=rate;
	 	 ds[1]-=increment;
	 	 rate=0.002503396417111947*s[2];
	 	 increment=rate;
	 	 ds[2]-=increment;
	 	 rate=0.7638168802247832*s[3];
	 	 increment=rate;
	 	 ds[3]-=increment;
	 	 rate=0.8716762812707807*s[4];
	 	 increment=rate;
	 	 ds[4]-=increment;
...
/**************Transcription rates*****************/
	 ...
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.605224,0.000000);
	 	 increment=rate;
	 	 ds[1]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.631275,0.000000);
	 	 increment=rate;
	 	 ds[3]+=increment;
	}
	 memory=step-0;
	 if(memory>=0){
	 	 rate=MAX(0.934970,0.000000);
	 	 increment=rate;
	 	 ds[4]+=increment;
	}
