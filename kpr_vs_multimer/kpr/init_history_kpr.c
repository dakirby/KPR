...
/*function returning the binding time corresponding to a given cell number. */
...
/*function returning the self ligand concentration corresponding to a given cell number. */
